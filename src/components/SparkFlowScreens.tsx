...
export function SparkFlowMilestoneModal({ milestone, contactName, onDismiss }: Props) {
...
export function BrokenSparkFlowScreen({ contactName, bestScore, onDismiss }: { contactName: string; bestScore: number; onDismiss: () => void }) {
  return (
