...
export function MessageList({ messages, myMood, customization, isOtherTyping, onLongPress, onReactionClick, onSeenByClick, onAcceptChallenge, onDeclineChallenge, onRematchChallenge, searchMode, searchQuery, searchResults, activeSearchId }: Props) {
                ...
                {(() => {
                  ...
                  return (
                    <motion.div
                      ...
                      animate={{
                         ...animateAnim,
                         opacity: (searchMode && searchQuery && !searchResults?.includes(message.id)) ? 0.35 : 1
                      }}
                    ...
                    >
                      ...
                      <MessageBubble
                        ...
                        isSearchFocused={searchMode && activeSearchId === message.id}
